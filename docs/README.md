...
Documentation communautaire de **Server Power Manager** — application de
bureau Windows (Tauri v2 + React) pour gérer et surveiller un homelab.
...
| Document | Contenu |
|---|---|
| [Extensions communautaires](extensions.md) | Modèle de sécurité, référence complète du manifeste, création d'une première extension, installation, espace de noms, versionnage, dépannage |

## Pour les contributeurs

| Document | Contenu |
|---|---|
| [CONTRIBUTING.md](CONTRIBUTING.md) | Compiler depuis les sources, lancer les tests, conventions de code, ajouter une commande Tauri, rappel de licence |

---

Cette documentation ne couvre que ce qui est vérifiable dans le code du
projet. Les notes de conception internes (dossier `docs/superpowers/`) ne font
pas partie de la documentation communautaire et ne sont pas listées ici.
