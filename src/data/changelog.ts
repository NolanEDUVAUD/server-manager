  ...
  },
  {
    ...
    items: {
      fr: [
        ...
        "Agent SSH : chaque clé est essayée, délai maximal, bouton « Tester l'agent » et aide détaillée",
      ...
      en: [
        ...
        "SSH agent: every key is tried, timeout, \"Test the agent\" button and detailed help",
